                ...
                <div class="container">
                    <nav class="navbar navbar-expand-md navbar-light">
                        <a class="navbar-brand" href="index.html">
                            <img class="logo-light" src="assets/img//ayurved/maha-ayurvedas.png" alt="logo" width="200px">
                        ...
                        <div class="collapse navbar-collapse main-menu-wrap" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                            <a href="service-one.html" class="nav-link">Services</a>
                                        </li>
                                        <li class="nav-item">
                                ...
                                <li class="nav-item d-lg-none">
                                    <a href="login.html" class="btn style2 w-block w-100">Login Now</a>
                                </li>
                            </ul>
                            <div class="other-options md-none">
                                ...
                                <div class="option-item">
                                    <a href="login.html" class="btn style2">Login Now</a>
                                </div>
