...
<!-- Hero Section End --> --}}
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                    <div class="hero-content">
                        <h1 data-aos="fade-up" data-aos-duration="1200" data-aos-delay="200">Welcome to <br><span><img
                                    src="{{ asset('assets/img/ayurved/maha-ayurvedas.png') }}" alt=""
                                    srcset=""></span></h1>
                        <p data-aos="fade-up" data-aos-duration="1200" data-aos-delay="300" style="font-size:20px;">We are
                            here to treat your diseases with the help of Indian traditional system of medicine.</p>
                        <a href="{{ url('/book-appointment') }}" class="btn style1" data-aos="fade-up"
                            data-aos-duration="1200" data-aos-delay="400">Book an Appointment</a>
                        <a href="{{ url('/shop') }}" class="btn style1" data-aos="fade-up" data-aos-duration="1200"
                            data-aos-delay="400">Visit Store Now</a>
                        <br>
                        <a href="{{ url('/contact') }}" class="btn style1 mt-2" data-aos="fade-up" data-aos-duration="1200"
                            data-aos-delay="400">Enquiry Now</a>
                        <a href="{{ url('/shop') }}" class="btn style1 mt-2" data-aos="fade-up" data-aos-duration="1200"
                            data-aos-delay="400">Upload Prescription</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="sidebar">
                    ...
                    <div class="sidebar-widget contact-widget">
                        ...
                        <h3>
                            ...
                            Upload Your Prescription / Order</h3>
                        <p>Upload your prescription to get your medicine as per your need at low cost.</p>
                        <span>
                            <i class="fa-solid fa-cart-shopping fa-2xl"
                                style="color: #fcfcfc; position:absolute; right:50px"></i>
                        </span>
                        <a href="https://api.whatsapp.com/send?phone=919775953377" target="_blank" class="btn style1">Upload
                            Now</a>
                    </div>
                </div>
            </div>
    ...
    <section class="product-cat-wrap mt-2">
        <div class="container">
            <div class="section-title style1 text-center mb-40">
                <span><img src="assets/img/section-img.png" alt="Image">Services</span>
                <h2>Our Services</h2>
            </div>
            <div class="row justify-content-center">
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 aos-init aos-animate" data-aos="fade-up"
                    ...
                    <div class="product-cat-card style1">
                        ...
                        <div class="product-cat-info">
                            <h3><a href="{{ url('/book-appointment') }}">Ayurvedic Doctor Video Consultation</a></h3>
                            {{-- <p>There are many variaties of rem amet consec but the major have suffered alteration in some
                                case amet. </p> --}}
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 aos-init aos-animate" data-aos="fade-up"
                    ...
                    <div class="product-cat-card style1">
                        ...
                        <div class="product-cat-info">
                            <h3><a href="{{ url('/shop') }}">Buy Ayurvedic Medicine <br>Online</a></h3>
                            {{-- <p>There are many variaties of rem amet consec but the major have suffered alteration in some
                                case amet. </p> --}}
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-xl-4 col-lg-6 col-md-6 aos-init" data-aos="fade-up" data-aos-duration="1200"
                    data-aos-delay="400">
                    <div class="product-cat-card style1">
                        ...
                        <div class="product-cat-info">
                            <h3><a href="https://api.whatsapp.com/send?phone=919775953377">Ayurvedic Doctor Instant
                                    Consultation</a></h3>
                            {{-- <p>There are many variaties of rem amet consec but the major have suffered alteration in some
                                case amet. </p> --}}
                        </div>
    ...
    <section class="product-cat-wrap ptb-25">
        <img src="{{ asset('assets/img/category/cat-shape-1.png') }}" alt="Image"
            class="cat-shape-one animationFramesTwo">
        <img src="{{ asset('assets/img/category/cat-shape-2.png') }}" alt="Image"
            class="cat-shape-two bounce sm-none">
        <div class="container">
            <div class="row">
                ...
                @if (!empty($lim_cats))
                    @foreach ($lim_cats as $lim_cat)
                        <div class="cat-card">
                            ...
                            @endif
                            <a class="cat-info"
                                href="{{ route('front.shop', $lim_cat->slug) }}">{{ $lim_cat->name }}</a>
                        </div>
                    @endforeach
                @endif
    ...
    <section class="benefit-wrap style2 ptb-50">
        <div class="container">
            <div class="section-title style1 text-center mb-40">
                    ...
                    <div class="benefit-img-wrap">
                        ...
                        <ul class="benefit-list-icon list-style">
                            ...
                            <li>
                                ...
                                <i class="fa-regular fa-circle-exclamation" style="color:current;"></i>
                            </li>
                            <li>
    ...
    <!-- About Section Start -->
    <section class="about-wrap style2 ptb-50">
        <div class="container">
            <div class="row gx-5 align-items-center">
                <div class="col-lg-7 order-lg-1 order-md-2 order-2" data-aos="fade-right" data-aos-duration="1200"
                    data-aos-delay="300">
                    <div class="about-content">
                        <div class="content-title style1">
                            <span><img src="{{ asset('assets/img/section-img.png') }}" alt="Image">About Maha
                                Ayurveda</span>
                            <h2>Our Speciality in Various Fields</h2>
                            <p>Ayurveda treatment may vary patient to patient. Thats why Maha Ayurveda can not give you 100%
                                garantee on treatment and suitability.</p>
                        </div>
                ...
                <div class="col-lg-5 order-lg-2 order-md-1 order-1" data-aos="fade-left" data-aos-duration="1200"
                    data-aos-delay="300">
    ...
    <section class="benefit-wrap pt-50 pb-50 bg-albastor">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="product-cat-card style2">
                                    ...
                                    <div class="product-cat-info">
                                        ...
                                        <p>You can communicate with our Doctors in 3 different languages acc to your choice.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="product-cat-card style2">
                                    ...
                                    <div class="product-cat-info">
                                        ...
                                        <p>At first we evaluate your body constitution and cause of the disease then we
                                            prescribe best quality medicine.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <section class="product-wrap style2 pt-50 bg-albastor">
                    ...
                    @foreach ($products as $product)
                        <div class="col-xl-3 col-lg-6 col-md-6" data-aos="fade-up" data-aos-duration="1200"
                            ...
                            <div class="product-card style2">
                                ...
                                @endif
                                <div class="product-info">
                                    <h3><a href="{{ route('front.product', $product->slug) }}">{{ $product->title }}</a>
                                    </h3>
    ...
    <!-- CTA  Section Start -->
    <div class="cta-wrap pt-75 pb-75">
        <div class="cta-shape">
                ...
                <div class="col-lg-6" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="300">
                    <div class="apply-form">
                        <div class="content-title style1">
                            ...
                            <p>Ayurveda treatment may vary man to man. Thats why Maha Ayurveda can not give you 100%
                                garantee on treatment and suitability of treatments.</p>
                        </div>
                        <form action="{{ url('/') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                @endif
                                <select class="form-select form-select-md" name="language" id="language"
    ...
    <!-- Team Section Start -->
    <section class="team-wrap ptb-50 pb-25">
        <div class="container">
            <div class="row">
                            ...
                            @if ($doctor->image != '')
                                <div class="team-img">
                                    ...
                                    <ul class="social-profile list-style style1">
                                        <a href="{{ route('index.appoinment', ['doctor' => $doctor->name]) }}"
                                            class="btn m-0 p-0">Book Now</a>
                                    </ul>
                                </div>
                            @endif
                            <div class="team-info">
        ...
        <div class="container">
            ...
            <div class="testimonial-slider-one owl-carousel">
                <div class="testimonial-card style3">
                    <p class="client-quote">I was suffering from pain calf muscle just below the knee joint due to
                        popliteal cyst. But after getting ayurveda treatment from Dr. Niladri Bose I am now 100% recovered
                        from that situation. Thanks to Dr. Niladri Bose & Maha Ayurveda.</p>
                ...
                <div class="testimonial-card style3">
                    <p class="client-quote">I have been suffering from recurrent tonsillitis since last few years. But with
                        help of Ayurveda treatment under guidance of Dr. Niladri Bose now I am very much fine, & my pain is
                        totally recovered. Thanks to Maha Ayurveda.</p>
                    <div class="client-info-area">
                        <div class="client-info-wrap">
                            <div class="client-img">
                ...
                <div class="testimonial-card style3">
                    <p class="client-quote">আমি বহুদিন ধরে অণ্ডকোষ জনিত সমস্যায় ভুগছিলাম, হাঁটা চলা করতে সমস্যা হত এবং
                        ব্যাথা অনুভব করতাম। আয়ুর্বেদ চিকিৎসার পর থেকে আমি এখন হাঁটা চলা করতে পারি ও ব্যাথা পাওয়া থেকে মুক্তি
                        পেয়েছি ।</p>
                    <div class="client-info-area">
                        <div class="client-info-wrap">
                            <div class="client-img">
